...
def make_env(env_name="PushCube-v1", device="cuda", from_pixels: bool = False):
    env = gym.make("PushCube-v1", num_envs=4)
    env = ManiSkillVectorEnv(env)
    env = ManiSkillWrapper(env, from_pixels=from_pixels, pixels_only=False)
